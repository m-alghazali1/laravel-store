...
@section('breadcrumb-main', 'Role Permissions')
@section('braedcrumb-sub', 'Role Permissions')
                                            ...
                                            <td>
                                                <div class="icheck-primary d-inline">
                                                    <input type="checkbox" id="permission_{{ $data->id }}"
                                                      ...
                                                      onchange="updateRolePermissions({{ $data->id }})"  @checked($data->assigned)>
...
@section('script')
    ...
    <script>
        function updateRolePermissions(permissionId) {
            console.log('loaded');
            axios.put('{{ route('admin.roles.update-permission') }}', {
