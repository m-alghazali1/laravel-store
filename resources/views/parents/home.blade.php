        ...
        <div class=" container justify-content-md-end">
            ...
            <div class="collapse navbar-collapse" id="minu">
                <ul class="navbar-nav justify-content-lg-start ">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('products.index') }}">Home</a>
                    </li>
                ...
                if (products.length > 0) {
                    products.forEach(product => {
                        if (product.images && product.images.length > 0) {
                            const image = `/storage/${product.images[0].image_url}`;

                            output += `
                                    <a href="/products/${product.id}" class="d-block mb-2 text-decoration-none text-dark">
                                        <div class="border p-2 rounded hover-shadow">
                                            <h5>${product.name}</h5>
                                            <img src="${image}" alt="${product.name}" style="max-width: 100px;">
                                        </div>
                                    </a>
                                `;
                        } else {
